...
const makeQueryString = (a) => {
  let str = "select u.id,u.image,u.name,u.email,u.surname,u.last_login,major_science.science from users as u LEFT JOIN major_science on u.major = major_science.id where ";
